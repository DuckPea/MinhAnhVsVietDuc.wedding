!function () {
    var t, e, i, o, r = {
        634: function () {
            Flatsome.behavior("equalize-box", {
                attach(t) {
                    let e = {
                        ScreenSize: {LARGE: 1, MEDIUM: 2, SMALL: 3}, equalizeItems: function (t) {
                            const e = this;
                            e.maxHeight = 0, e.rowEnd = e.disablePerRow ? e.boxCount : e.colPerRow, e.$items = [], e.rating = {
                                ...
                                var r;
                                o.length && (e.rating.present = !0, e.rating.height = o.height(), e.rating.dummy = null !== (r = e.rating.dummy) && void 0 !== r ? r : '<div class="js-star-rating ' + o.attr("class") + '" style="opacity: 0; visibility: hidden"></div>'), i.children(".js-ux-swatches").remove();
                                const a = i.children(".ux-swatches.ux-swatches-in-loop");
                                var n;
                                a.length && (e.swatches.present = !0, e.swatches.height = a.height(), e.swatches.dummy = null !== (n = e.swatches.dummy) && void 0 !== n ? n : '<div class="js-ux-swatches ' + a.attr("class") + '" style="opacity: 0; visibility: hidden"><div class="' + a.find(".ux-swatch").attr("class") + '"></div></div>'), i.height() > e.maxHeight && (e.maxHeight = i.height()), t !== e.rowEnd - 1 && t !== e.boxCount - 1 || (e.$items.forEach((function (t) {
                            ...
                            const t = jQuery(this.currentElement).attr("class"), e = /large-columns-(\d+)/g,
                                i = /medium-columns-(\d+)/g, o = /small-columns-(\d+)/g;
                            let r;
                            ...
                            jQuery(".equalize-box", t).each(((t, o) => {
                                e.currentElement = o, e.colPerRow = e.getColsPerRow(), 1 !== e.colPerRow && (e.disablePerRow = jQuery(o).hasClass("row-slider") || jQuery(o).hasClass("row-grid"), e.boxCount = jQuery(".box-text", e.currentElement).length, i.forEach((t => {
            ...
            Flatsome.plugin("addQty", (function (t, e) {
                ...
                String.prototype.uxGetDecimals || (String.prototype.uxGetDecimals = function () {
                    ...
                    const t = jQuery(this), e = t.closest(".quantity").find(".qty");
                    let i = parseFloat(e.val()), o = parseFloat(e.attr("max")), r = parseFloat(e.attr("min")),
                        a = e.attr("step");
                    i && "" !== i && "NaN" !== i || (i = 0), "" !== o && "NaN" !== o || (o = ""), "" !== r && "NaN" !== r || (r = 0), "any" !== a && "" !== a && void 0 !== a && "NaN" !== parseFloat(a) || (a = 1), t.is(".plus") ? o && (o === i || i > o) ? e.val(o) : e.val((i + parseFloat(a)).toFixed(a.uxGetDecimals())) : r && (r === i || i < r) ? e.val(r) : i > 0 && e.val((i - parseFloat(a)).toFixed(a.uxGetDecimals())), e.trigger("input"), e.trigger("change")
                }))
            }))
        }, 4168: function (t, e, i) {
            var o, r;
            !function (a, n) {
                ...
                o = [i(9567)], r = function (t) {
                    !function (t) {
                        ...
                        function c(e, i) {
                            this.$target = t(e), this.opts = t.extend({}, s, i, this.$target.data()), void 0 === this.isOpen && this._init()
                        }
                        ...
                        c.prototype._init = function () {
                            ...
                            if (!1 !== this.opts.beforeShow.call(this)) {
                                ...
                                var s = this.$target.outerWidth(), c = this.$target.outerHeight(),
                                    l = this.$flyout.width(), u = this.$flyout.height(), d = this.$zoom.width(),
                                    h = this.$zoom.height();
                                e = Math.ceil(d - l), i = Math.ceil(h - u), o = (e = e < 0 ? 0 : e) / s, r = (i = i < 0 ? 0 : i) / c, this.isOpen = !0, this.opts.onShow.call(this), t && this._move(t)
                            }
                            ...
                            n = 0 === t.type.indexOf("touch") ? (s = t.touches || t.originalEvent.touches, a = s[0].pageX, s[0].pageY) : (a = t.pageX || a, t.pageY || n);
                            var s = this.$target.offset();
                            t = a - s.left, s = n - s.top, t = Math.ceil(t * o), s = Math.ceil(s * r), t < 0 || s < 0 || e < t || i < s ? this.hide() : (s *= -1, t *= -1, "transform" in document.body.style ? this.$zoom.css({transform: "translate(" + t + "px, " + s + "px)"}) : this.$zoom.css({
                                top: s,
                                left: t
    ...
    n.m = r, e = Object.getPrototypeOf ? function (t) {
        ...
        var a = {};
        t = t || [null, e({}), e([]), e(e)];
        for (var s = 2 & o && i; "object" == typeof s && !~t.indexOf(s); s = e(s)) Object.getOwnPropertyNames(s).forEach((function (t) {
            a[t] = function () {
                return i[t]
            }
        }));
    ...
    }, i = {}, o = "flatsome:", n.l = function (t, e, r, a) {
        if (i[t]) i[t].push(e); else {
            var s, c;
            ...
            s || (c = !0, (s = document.createElement("script")).charset = "utf-8", s.timeout = 120, n.nc && s.setAttribute("nonce", n.nc), s.setAttribute("data-webpack", o + r), s.src = t), i[t] = [e];
            var h = function (e, o) {
                s.onerror = s.onload = null, clearTimeout(m);
                var r = i[t];
                if (delete i[t], s.parentNode && s.parentNode.removeChild(s), r && r.forEach((function (t) {
                    return t(o)
                })), e) return e(o)
        ...
        const t = n.u;
        n.u = e => {
            const i = t(e), o = globalThis.flatsomeVars?.theme.version;
            return i + (o ? "?ver=" + o : "")
        }
    }(), n.p = globalThis.flatsomeVars?.assets_url ?? "/", function () {
        var t = {960: 0};
        n.f.j = function (e, i) {
            var o = n.o(t, e) ? t[e] : void 0;
            if (0 !== o) if (o) i.push(o[2]); else {
                var r = new Promise((function (i, r) {
                    o = t[e] = [i, r]
                }));
                i.push(o[2] = r);
                var a = n.p + n.u(e), s = new Error;
                n.l(a, (function (i) {
                    if (n.o(t, e) && (0 !== (o = t[e]) && (t[e] = void 0), o)) {
                        var r = i && ("load" === i.type ? "missing" : i.type), a = i && i.target && i.target.src;
                        s.message = "Loading chunk " + e + " failed.\n(" + r + ": " + a + ")", s.name = "ChunkLoadError", s.type = r, s.request = a, o[1](s)
                    }
                }), "chunk-" + e, e)
            }
        };
        var e = function (e, i) {
            ...
            for (e && e(i); l < a.length; l++) r = a[l], n.o(t, r) && t[r] && t[r][0](), t[r] = 0
        }, i = self.flatsomeChunks = self.flatsomeChunks || [];
        i.forEach(e.bind(null, 0)), i.push = e.bind(null, i.push.bind(i))
    }(), function () {
        "use strict";
        n(4168), n(6619), n(9222), n(634);
        ...
        i(), t.addEventListener?.("change", i), jQuery.loadMagnificPopup = o, jQuery.fn.lazyMagnificPopup = function (t) {
            const e = jQuery(this), i = t.delegate ? e.find(t.delegate) : e;
            return i.one("click", (r => {
                r.preventDefault(), o().then((() => {
                ...
                "uxBuilder" !== jQuery("html").attr("ng-app") && jQuery(".quick-view", t).each((function (t, i) {
                    jQuery(i).hasClass("quick-view-added") || (jQuery(i).on("click", (function (t) {
                        if ("" != jQuery(this).attr("data-prod")) {
                            ...
                            var r = {action: "flatsome_quickview", product: jQuery(this).attr("data-prod")};
                                ...
                                o().then((() => {
                                    ...
                                    jQuery.when(c).done((() => {
                                        o.on("hide_variation", (function (t, e) {
                                            a.attr("src", s).attr("srcset", ""), u()
                                        })), o.on("click", ".reset_variations", (function () {
                                            a.attr("src", s).attr("srcset", ""), l(), u()
                                        }))
                                    })), o.on("show_variation", (function (t, e) {
                                        jQuery.when(c).done((() => {
                                            e.image.src ? (a.attr("src", e.image.src).attr("srcset", ""), n.attr("href", e.image_link), l(), u()) : e.image_src && (a.attr("src", e.image_src).attr("srcset", ""), n.attr("href", e.image_link), l(), u())
                                        }))
        ...
        }), document.documentElement.style, window.getComputedStyle(document.documentElement)["scroll-behavior"];
        var r = !1;
        ...
        function s(t) {
            if (jQuery(".cart-item .nav-dropdown").length) jQuery(".cart-item").addClass("current-dropdown cart-active"), jQuery(".shop-container").on("click", (function () {
                ...
                let t = 0;
                jQuery.fn.magnificPopup && (t = jQuery.magnificPopup.open ? 300 : 0, t && jQuery.magnificPopup.close()), setTimeout((function () {
        ...
        jQuery(document).on("flatsome-product-gallery-tools-init", (() => {
            ...
            const e = window.location.hash, i = window.location.href;

            function o() {
                !function () {
                    const e = t(".reviews_tab"), i = e.length ? e : t("#reviews").closest(".accordion-item");
                    i.length && i.find("a:not(.active):first").trigger("click")
                }(), setTimeout((() => {
                    t.scrollTo("#reviews", {offset: -window.flatsomeVars.scrollPaddingTop - 15})
                }), 500)
            }
            ...
            const e = t(".product-thumbnails .first img").attr("data-src") ? t(".product-thumbnails .first img").attr("data-src") : t(".product-thumbnails .first img").attr("src"),
                i = t("form.variations_form"), o = t(".product-gallery-slider"), n = t(".product-thumbnails");
            let s = null;
            const c = t.Deferred(), l = t.Deferred();
            o.one("flatsome-flickity-ready", (() => c.resolve())), n.one("flatsome-flickity-ready", (() => l.resolve())), n.length && !n.is(":hidden") || l.resolve();
            const u = function () {
            ...
            const m = t.when(c, l).then((() => {
                a && h(), i.on("hide_variation", (function (i, o) {
            ...
            i.on("show_variation", (function (i, o) {
                t.when(m).done((() => {
                    o.hasOwnProperty("image") && o.image.thumb_src ? (t(".product-gallery-slider-old .slide.first img, .sticky-add-to-cart-img, .product-thumbnails .first img, .product-gallery-slider .slide.first .zoomImg").attr("src", o.image.thumb_src).attr("srcset", ""), d(), u(), h()) : (t(".product-thumbnails .first img").attr("src", e), h())
                }))
            }))
        })), flatsomeVars.is_mini_cart_reveal && (jQuery("body").on("added_to_cart", (function () {
            s("5000");
            const t = jQuery("#header"), e = t.hasClass("has-sticky"), i = jQuery(".header-wrapper", t);
        ...
        const c = function (t) {
            ...
            const {top: e} = t.boundingClientRect, i = t.intersectionRatio <= 0 && e <= 0, o = jQuery(t.target),
                r = o.find(".sticky-add-to-cart");
            o.css({height: i ? o.outerHeight() : ""}), r.toggleClass("sticky-add-to-cart--active", i), jQuery("body").toggleClass("has-sticky-product-cart", i)
        }), {threshold: 0});
