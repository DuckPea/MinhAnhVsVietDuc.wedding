!function () {
        ...
        7387: function () {
            ...
            Flatsome.behavior("commons", {
                attach(e) {
                    jQuery("select.resizeselect").resizeselect(), jQuery("[data-parallax]", e).flatsomeParallax(), jQuery.fn.packery && (jQuery("[data-packery-options], .has-packery", e).each((function () {
                        let e = jQuery(this);
                        e.packery({originLeft: !flatsomeVars.rtl}), setTimeout((function () {
            ...
            function o(e) {
                e.addClass("current-dropdown"), e.find(".nav-top-link").attr("aria-expanded", !0), function (e) {
                    const t = e, o = t.closest(".container").width(), i = t.closest("li.menu-item"),
                        a = i.hasClass("menu-item-design-full-width"),
                        r = i.hasClass("menu-item-design-container-width"),
                        s = i.parent().hasClass("ux-nav-vertical-menu"), l = !a && !r, c = n.g.flatsomeVars.rtl;
                    if (l && !s) {
                        if (o < 750) return !1;
                        var u = t.outerWidth(), d = t.offset(),
                            h = Math.max(document.documentElement.clientWidth, window.innerWidth || 0),
                            f = d.left - (h - o) / 2;
                        c && (f = jQuery(window).width() - (d.left + u) - (h - o) / 2);
                        var p = t.width(), y = o - (f + p), m = !1;
                        f > y && f < p && (m = (f + y) / 3), y < 0 && (m = -y), m && c ? t.css("margin-right", -m) : m && t.css("margin-left", -m), p > o && t.addClass("nav-dropdown-full")
                    }
                    if (r) {
                        t.css({inset: "0"});
                        const e = t.closest(".container").get(0).getBoundingClientRect(),
                            n = t.get(0).getBoundingClientRect();
                        t.css({width: s ? o - i.width() : o, ...!c && {left: e.left - n.left + 15}, ...c && {right: 15 - (e.right - n.right)}})
                    }
                    if (a) {
                        t.css({inset: "0"});
                        const e = document.body, n = e.getBoundingClientRect(), o = t.get(0).getBoundingClientRect(),
                            a = e.clientWidth;
                        t.css({...!c && {width: s ? a - i.get(0).getBoundingClientRect().right : a}, ...c && {width: s ? i.get(0).getBoundingClientRect().left : a}, ...!c && {left: n.left - o.left}, ...c && {right: -(n.right - o.right)}})
                    }
                    if ((r || a) && !s) {
                        let e = null;
                        if (i.closest("#top-bar").length && (e = document.querySelector("#top-bar")), i.closest("#masthead").length && (e = document.querySelector("#masthead")), i.closest("#wide-nav").length && (e = document.querySelector("#wide-nav")), null !== e) {
                            const n = e.getBoundingClientRect(), o = i.get(0).getBoundingClientRect();
                            t.css({top: n.bottom - o.bottom + o.height})
                        }
                    }
                }(e.find(".nav-dropdown"))
            }
            ...
            Flatsome.behavior("dropdown", {
                attach(e) {
                    const t = jQuery(".nav li.has-dropdown", e), n = "uxBuilder" === jQuery("html").attr("ng-app"),
                    ...
                    jQuery(".header-nav > li > a, .top-bar-nav > li > a", e).on("focus", (() => {
                        ...
                        f.on("touchstart click", (function (e) {
                            "touchstart" === e.type && (y = !0), "click" === e.type && y && (y && !m && e.preventDefault(), m = !0)
                        })), n || p ? (u = !0, f.on("click", "a:first", (function (e) {
                            if (e.preventDefault(), d = f, f.hasClass("current-dropdown")) return i(f), void s(l, "click");
                            a(t), o(f), r(l, "click"), jQuery(document).trigger("flatsome-dropdown-opened", [f])
                        }))) : (f.on("keydown", "a:first", (function (e) {
                            "Space" === e.code && (e.preventDefault(), f.hasClass("current-dropdown") ? (i(f), s(l, "click")) : (a(t), o(f), r(l, "click"), jQuery(document).trigger("flatsome-dropdown-opened", [f])))
                        })), f.hoverIntent({
                            sensitivity: 3, interval: 20, timeout: 70, over(e) {
                                a(t), o(f), s(l, "click"), jQuery(document).trigger("flatsome-dropdown-opened", [f])
                            }, out() {
                                m = !1, y = !1, i(f)
                            }
                        }))
                    })), !n && u && jQuery(document).on("click", (function (e) {
                        null === d || d === e.target || d.has(e.target).length || (i(d), s(l, "click"))
            ...
            Flatsome.behavior("sidebar-tabs", {
                attach(e) {
                    jQuery(".sidebar-menu-tabs", e).each(((e, t) => {
                        const n = jQuery(t), o = n.find(".sidebar-menu-tabs__tab"),
            ...
            Flatsome.behavior("scroll-to", {
                attach() {
                    const e = jQuery("span.scroll-to"), t = parseInt(flatsomeVars.sticky_height, 10),
                        n = jQuery("#wpadminbar");
                    if (!e.length) return;
                    ...
                    o.length ? (o.children().lazyTooltipster("destroy"), o.empty()) : (o = jQuery('<div class="scroll-to-bullets hide-for-medium"/>'), jQuery("body").append(o)), jQuery("li.scroll-to-link").remove(), e.each((function (e, t) {
                        let i = jQuery(t), a = i.data("link"), r = i.data("title"), s = `a[href="${a || "<nolink>"}"]`;
                        if (i.data("bullet")) {
                        ...
                        jQuery("li.nav-single-page").before(l), setTimeout((function () {
                            ...
                            o && n.length && n.is(":visible") && (o = Number(o) + Number(n.height())), setTimeout((() => {
                                jQuery.scrollTo(`a[name="${t}"]`, {...!isNaN(o) && {offset: -o}})
                    ...
                    const a = () => {
                        clearTimeout(i), i = setTimeout((() => {
                            ...
                            o.find("a").each(((e, o) => {
                                const i = n[e], a = n[e + 1] || window.innerHeight, r = i <= t + 100 && a > t + 100;
                                jQuery(o).toggleClass("active", r)
                            }))
                        }), 100)
                    };
                    if (window.addEventListener("scroll", a, {passive: !0}), window.addEventListener("resize", a), a(), location.hash) {
                        const e = decodeURIComponent(location.hash.replace("#", ""));
                        let t = jQuery(`a[name="${e}"]`).closest(".scroll-to").attr("data-offset");
                        t && n.length && n.is(":visible") && (t = Number(t) + Number(n.height())), jQuery.scrollTo(`a[name="${e}"]`, {...!isNaN(t) && {offset: -t}})
                    }
                }, detach() {
            ...
            Flatsome.behavior("tabs", {
                attach(t) {
                    ...
                    jQuery(".tabbed-content", t).each((function (t, i) {
                        const a = jQuery(i), r = a.find("> .nav > li"), s = a.find("> .tab-panels > .panel"),
                        ...
                        s.removeAttr("style"), r.each((function (t, i) {
                            ...
                            u.on("click", (function (n) {
                                ...
                                sensitivity: 3, interval: 20, timeout: 70, over(n) {
                                    e(t, r, s)
                                }, out() {
                                }
                            }), n.substring(1).length && decodeURIComponent(n.substring(1)) === u.attr("href")?.split("#")[1] && (e(t, r, s), o || (o = !0, setTimeout((() => {
                                jQuery.scrollTo(a)
                            }), 500)))
                        }))
                    }))
            ...
            Flatsome.behavior("toggle", {
                attach(e) {
                    ...
                    jQuery(".sidebar-menu li.menu-item.has-child", e).each((function () {
                        let e = jQuery(this), o = e.find("> a:first");
            ...
            Flatsome.behavior("youtube", {
                attach(e) {
                    ...
                    0 !== r.length && (window.onYouTubePlayerAPIReady = function () {
                        r.each((function () {
                            var e = jQuery(this), t = e.attr("id"), n = e.data("videoid"), o = e.data("loop"),
                                i = e.data("audio");
                            new YT.Player(t, {
                                height: "100%",
                                width: "100%",
            ...
            n.g.Flatsome = {
                behaviors: {}, plugin(e, t, n) {
                    n = n || {}, jQuery.fn[e] = function (o) {
                        if ("string" == typeof arguments[0]) {
                            var i = null, a = arguments[0], r = Array.prototype.slice.call(arguments, 1);
            ...
            jQuery(".section .loading-spin, .banner .loading-spin, .page-loader").fadeOut(), jQuery("#top-link").on("click", (function (e) {
                ...
                const e = jQuery(this);
                let t = e.data("link");
                const n = e.data("backend"), o = e.data("title"), i = e.parents('[id^="menu-item-"]');
                ...
                const e = new URLSearchParams(window.top.location.search), t = parseInt(e.get("menu_id"));
                t && setTimeout((() => {
                    const e = jQuery(`#menu-item-${t}`), n = e.parent().hasClass("ux-nav-vertical-menu");
            ...
            Flatsome.plugin("resizeselect", (function (e, t) {
                jQuery(e).on("change", (function () {
                    var e = jQuery(this), t = e.find("option:selected").val(), n = e.find("option:selected").text(),
            ...
            var o;
            o = void 0 !== n.g ? n.g : this, e.exports = function (e, t, n) {
                if (void 0 === t) {
                    var i = ("; " + o.document.cookie).split("; " + e + "=");
                ...
                if (void 0 === document.documentElement.style["touch-action"] && !document.documentElement.style["-ms-touch-action"] && t && e) {
                    ...
                    window.Hammer.time = {
                        getTouchAction: function (e) {
                            ...
                            if ("none" === t) this.dropHammer(e); else if ("manipulation" === t) {
                            ...
                            for (var t, n = e; n && n.parentNode; n = n.parentNode) if (t = this.getTouchAction(n)) return t;
                            return !1
                ...
                o = [n(4944)], i = function (e) {
                    return function (e, t) {
                        ...
                        return r.prototype.addElementBackgroundImages = function (e) {
                            ...
                            if (t) for (var n = /url\((['"])?(.*?)\1\)/gi, o = n.exec(t.backgroundImage); null !== o;) {
                                var i = o && o[2];
            ...
            !function (r) {
                ...
                i = [n(9567)], void 0 === (a = "function" == typeof (o = function (e) {
                    ...
                    return t.defaults = {axis: "xy", duration: 0, limit: !0}, e.fn.scrollTo = function (a, r, s) {
                        "object" == typeof r && (s = r, r = 0), "function" == typeof s && (s = {onAfter: s}), "max" === a && (a = 9e9), s = e.extend({}, t.defaults, s), r = r || s.duration;
                        var l = s.queue && s.axis.length > 1;
                        return l && (r /= 2), s.offset = i(s.offset), s.over = i(s.over), this.each((function () {
                            if (null !== a) {
                                var c, u = n(this), d = u ? this.contentWindow || window : this, h = e(d), f = a,
                                    p = {};
                                switch (typeof f) {
                                    case"number":
                                    case"string":
                                ...
                                e.each(s.axis.split(""), (function (e, n) {
                                    var o = "x" === n ? "Left" : "Top", i = o.toLowerCase(), a = "scroll" + o,
                                        r = h[a](), g = t.max(d, n);
                                    if (c) p[a] = c[i] + (u ? 0 : r - h.offset()[i]), s.margin && (p[a] -= parseInt(f.css("margin" + o), 10) || 0, p[a] -= parseInt(f.css("border" + o + "Width"), 10) || 0), p[a] += y[i] || 0, s.over[i] && (p[a] += f["x" === n ? "width" : "height"]() * s.over[i]); else {
                                        var v = f[i];
                        ...
                        var r = "client" + i, s = t.ownerDocument || t.document, l = s.documentElement, c = s.body;
    ...
    r.m = i, r.n = function (e) {
        ...
        var a = {};
        e = e || [null, t({}), t([]), t(t)];
        for (var s = 2 & o && n; "object" == typeof s && !~e.indexOf(s); s = t(s)) Object.getOwnPropertyNames(s).forEach((function (e) {
            a[e] = function () {
                return n[e]
            }
        }));
        ...
        return "js/chunk." + {255: "tooltips", 288: "lottie", 309: "slider", 408: "countup", 964: "popups"}[e] + ".js"
        ...
        const e = r.u;
        r.u = t => {
            const n = e(t), o = globalThis.flatsomeVars?.theme.version;
            return n + (o ? "?ver=" + o : "")
        }
    }(), r.p = globalThis.flatsomeVars?.assets_url ?? "/", function () {
        var e = {259: 0};
        r.f.j = function (t, n) {
        ...
        "use strict";
        var e = r(6239), t = r.n(e);
        r(2702), r(7243), r(5114), r(9343);
        const n = document.body, o = "body-scroll-lock--active",
            i = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent);
        let a = 0;

        function s() {
            if (!i) return;
            a = window.pageYOffset;
            const e = document.getElementById("wpadminbar"), t = a - (e ? e.offsetHeight : 0);
            n.style.overflow = "hidden", n.style.position = "fixed", n.style.top = `-${t}px`, n.style.width = "100%", n.classList.add(o)
        }

        function l() {
            i && (n.style.removeProperty("overflow"), n.style.removeProperty("position"), n.style.removeProperty("top"), n.style.removeProperty("width"), window.scrollTo(0, a), n.classList.remove(o))
        }

        function c(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = 0;
            const o = t => {
                const o = window.scrollY;
                e(t, {direction: o > n ? "down" : "up", scrollY: o}), n = o
            };
            return window.addEventListener("scroll", o, {...t, passive: !0}), () => {
                window.removeEventListener("scroll", o)
            }
        }

        const u = jQuery("#header"), d = u.find(".header-wrapper"), h = jQuery(".header-top", u),
            f = jQuery(".header-main", u), p = u.hasClass("has-sticky"), y = u.hasClass("sticky-hide-on-scroll");
        let m, g, v;

        function b(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "down";
            void 0 === g && void 0 === v && (u.hasClass("sticky-shrink") ? (g = h.hasClass("hide-for-sticky") ? h.height() : 0, g += f.hasClass("hide-for-sticky") ? f.height() : 0, v = 1 + g) : (g = d.height() + 100, v = h.hasClass("hide-for-sticky") ? h.height() + 1 : 1)), y ? "down" === t || e < v ? e < v ? w() : m = setTimeout(w, 100) : e > g && (m = setTimeout(j, 100)) : e > g ? j() : e < v && w()
        }

        function j() {
            if (d.hasClass("stuck")) return;
            const e = u.height();
            jQuery(document).trigger("flatsome-header-sticky"), d.addClass("stuck"), u.height(e), jQuery(".has-transparent").removeClass("transparent"), jQuery(".toggle-nav-dark").removeClass("nav-dark"), y && u.addClass("sticky-hide-on-scroll--active")
        }

        function w() {
            d.hasClass("stuck") && (u.height(""), d.removeClass("stuck"), jQuery(".has-transparent").addClass("transparent"), jQuery(".toggle-nav-dark").addClass("nav-dark"), y && u.removeClass("sticky-hide-on-scroll--active"))
        }

        p && document.addEventListener("DOMContentLoaded", (() => {
            c(((e, t) => {
                let {scrollY: i, direction: a} = t;
                m && (clearTimeout(m), m = void 0), n.classList.contains(o) || b(i, a)
            })), m = setTimeout((() => {
        ...
        function L() {
            C.length && (cancelAnimationFrame(E), E = requestAnimationFrame((() => {
                for (let e = 0; e < C.length; e++) C[e].element.offsetParent ? T(C[e]) : C.splice(e, 1)
            })))
        }

        function T(e) {
            !function (e) {
                let {element: t, type: n} = e, o = O(t.dataset.parallax), i = I(t),
                ...
                let {element: t, type: n} = e, o = O(t.dataset.parallax || t.dataset.parallaxBackground),
                    i = window.innerHeight, a = I(t), r = t.offsetHeight - a.offsetHeight,
                    s = t.getBoundingClientRect(), l = a !== t ? a.getBoundingClientRect() : s,
                    c = s.top + t.offsetHeight / 2, u = i / 2 - c, d = i / 2 - (l.top + a.offsetHeight / 2),
                    h = c + _() < i / 2 ? _() : u, f = (Math.abs(u), Math.abs(h) / (i / 2)), p = 0;
                var y;
        ...
        function B(e) {
            return new IntersectionObserver((function (t) {
                ...
                rootMargin: "0px",
                threshold: .1, ...arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
            })
        }
        ...
        window.addEventListener("scroll", L, {passive: !0}), window.addEventListener("resize", L), new MutationObserver(L).observe(document.body, {childList: !0}), window.jQuery && (window.jQuery.fn.flatsomeParallax = function (e) {
            Q || "destroy" !== e && this.each(((e, t) => function (e) {
                e.classList.add("parallax-active"), !document.querySelector("body").classList.contains("parallax-mobile") && /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent) || e.classList && e.dataset && (C.push({
                    element: e,
                    type: P(e)
                }), T(C[C.length - 1]))
            }(t)))
        }), r(8417), jQuery.fn.flickity || (A.isFlickityStub = !0, jQuery.fn.flickity = A), jQuery.fn.lazyFlickity = function (e) {
            const t = B((n => {
                if (n.isIntersecting) {
                    if (t.unobserve(n.target), !jQuery.fn.flickity || jQuery.fn.flickity === A) return r.e(309).then(r.t.bind(r, 2066, 23)).then((() => {
        ...
        }, jQuery.loadMagnificPopup = D, jQuery.fn.lazyMagnificPopup = function (e) {
            const t = jQuery(this), n = e.delegate ? t.find(e.delegate) : t;
            return n.one("click", (o => {
                o.preventDefault(), D().then((() => {
        ...
        Flatsome.behavior("animate", {
            attach(e) {
                ...
                jQuery("[data-animate]", e).each(((e, n) => {
                    const o = jQuery(n), i = o.data("animate");
                    if (t || 0 === i.length || Q) return o.attr("data-animated", "true");
                    M.observe(n)
                }))
            }, detach(e) {
                jQuery("[data-animate]", e).each(((e, t) => {
                    jQuery(t).attr("data-animated", "false"), M.unobserve(t)
                }))
            }
        }), r(1478);
        const S = B((e => {
            if (e.intersectionRatio > 0) {
                ...
                r.e(408).then(r.bind(r, 5288)).then((e => {
                    ...
                    new n(t.get(0), o, {decimalPlaces: 0, duration: 4}).start(), t.addClass("active")
                }))
            }
        }));
        Flatsome.behavior("count-up", {
        ...
        }), r(7467), Flatsome.behavior("instagram", {
            attach(e) {
                const t = B((e => {
                    if (e.intersectionRatio > 0) {
                        t.unobserve(e.target);
                        const n = jQuery(e.target), o = n.data("flatsome-instagram"), i = e => {
            ...
            attach(e) {
                jQuery(".lightbox-by-id", e).each((function () {
                    ...
                    jQuery('a[href="#' + t + '"]', e).on("click", (e => {
                        ...
                        D().then((() => {
                            let e = t.attr("href").substring(1), n = jQuery(`#${e}.lightbox-by-id`);
                            if (e && n.length > 0) {
                                let e = n[0], t = jQuery.magnificPopup.open ? 300 : 0;
            ...
            attach(e) {
                jQuery("[data-open]", e).on("click", (e => {
                    ...
                    const t = jQuery(e.currentTarget);
                    D().then((() => {
                        var e = t.data("open"), n = t.data("color"), o = t.data("bg"), i = t.data("pos"),
                            a = t.data("visible-after"), r = t.data("class"), c = t.attr("data-focus");
                        t.offset(), t.addClass("current-lightbox-clicked"), jQuery.magnificPopup.open({
                            items: {
                                src: e,
                                type: "inline",
                                tLoading: '<div class="loading-spin dark"></div>'
                            ...
                            callbacks: {
                                beforeOpen: function () {
                                    this.st.mainClass = `off-canvas ${n} off-canvas-${i}`, s()
                                }, open: function () {
                                    jQuery("html").addClass("has-off-canvas"), jQuery("html").addClass("has-off-canvas-" + i), r && jQuery(".mfp-content").addClass(r), o && jQuery(".mfp-bg").addClass(o), jQuery(".mfp-content .resize-select").change(), jQuery.fn.packery && jQuery("[data-packery-options], .has-packery").packery("layout"), jQuery(".equalize-box", this.content).length && Flatsome.attach("equalize-box", this.content)
                                }, beforeClose: function () {
                                    jQuery("html").removeClass("has-off-canvas"), l()
                                }, afterClose: function () {
                                    jQuery("html").removeClass("has-off-canvas-" + i), jQuery(".current-lightbox-clicked").removeClass("current-lightbox-clicked"), a && jQuery(e).removeClass("mfp-hide")
                                }
                            }
                        })
                    }))
            ...
            attach(e) {
                ...
                (t = jQuery(e).data("flickityOptions") ? jQuery(e) : jQuery("[data-flickity-options]", e)).length && t.each(((e, t) => {
                    var n = jQuery(t), o = n.closest(".slider-wrapper"), i = n.data("flickity-options");
                    if ("undefined" != typeof UxBuilder && (i.draggable = !1), !0 === i.watchCSS) return;
                    let a = !1, r = !1;
                    const s = e => {
                        try {
                            a = t.contains(e.target), !i.pauseAutoPlayOnHover || a || r || n.flickity("playPlayer")
                        } catch (e) {
                        }
                    };
                        ...
                        if (e && i.parallax) {
                            ...
                            n.addClass("slider-has-parallax"), n.on("scroll.flickity", (function (n, o) {
                                e.slides.forEach((function (n, o) {
                                    const a = t[o], r = -1 * (n.target + e.x) / i.parallax;
                                    a && (a.style.transform = "translateX( " + r + "px)")
                                }))
                            }))
                        }
                        document.addEventListener("touchstart", s, {passive: !0})
                    })), Q && (i.friction = 1, i.selectedAttraction = 1, i.autoPlay = !1), n.lazyFlickity(i), n.imagesLoaded((function () {
                ...
                jQuery.fn.flickity && !jQuery.fn.flickity.isFlickityStub && (jQuery(e).data("flickityOptions") ? jQuery(e).flickity("destroy") : jQuery("[data-flickity-options]", e).flickity("destroy"))
            }
            ...
            attach(e) {
                ...
                jQuery(".accordion-title", e).each((function () {
                    ...
                    })), t.substring(1).length && decodeURIComponent(t.substring(1)) === jQuery(this).attr("href")?.split("#")[1] && (jQuery(this).hasClass("active") || jQuery(this).trigger("click"), n || (n = !0, setTimeout((() => {
        ...
        const z = B((e => {
            e.intersectionRatio > 0 && (z.unobserve(e.target), jQuery(e.target).addClass("bg-loaded"))
        }));
        ...
        Flatsome.behavior("sticky-sidebar", {
            attach(e) {
                jQuery('.is-sticky-column[data-sticky-mode="javascript"]', e).each(((e, t) => {
                    "ResizeObserver" in window && t.offsetParent && t.offsetParent !== document.body ? jQuery(t).data($, function (e) {
                        const {offsetParent: t} = e, n = parseInt(flatsomeVars.sticky_height, 10) + 30,
                            o = {passive: !0, capture: !1};
                        if (!t || t === document.body) return;
                        let {innerHeight: i} = window, a = null, r = null, s = 0, l = null, u = null;
                        const d = function () {
                            let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "down";
                            const o = window.scrollY + n - Math.round(a?.top), c = i + s - n - Math.round(r?.height),
                                d = Math.max(Math.min(c, Math.round(a?.height - r?.height)), 0);
                            let h = null, f = null;
                            !a || r?.height < i - n ? f = n : "down" === t ? o <= s ? h = d : r?.height - o <= i && (f = i - Math.round(r?.height), s = o) : "up" === t && (o <= c ? (f = n, s = o + Math.round(r?.height) - i + n) : h = d), h === l && f === u || (e.style.top = "number" == typeof f ? `${f}px` : f, e.style.transform = "number" == typeof h ? `translateY(${h}px)` : h), u = f, l = h
                        }, h = function (e) {
                            if ("ResizeObserver" in window) return new ResizeObserver((function (t) {
                                for (let n = 0; n < t.length; n++) e(t[n])
                            }))
                        }((n => {
                            let {target: o, contentRect: i} = n;
                            if (o === t) {
                                const e = H(t), {x: n, y: o, width: r, height: s} = i;
            ...
            attach(e) {
                ...
                const n = B((e => {
                    e.isIntersecting && (n.unobserve(e.target), function (e) {
                        const t = e, n = JSON.parse(t.dataset.params);
                        let o = null, i = null, a = !1;

                        function s(e) {
                            if (0 === parseInt(e)) return i.ip;
                            if (100 === parseInt(e)) return i.op;
                            const t = parseInt(i.ip), n = e * (parseInt(i.op) - t) / 100 + t;
                            return Math.ceil(n)
                        }
                        ...
                        Promise.all([r.e(288).then(r.bind(r, 4600)), r.e(288).then(r.bind(r, 5534))]).then((e => {
                            ...
                            t.load(n.src), t.addEventListener("ready", (() => {
                                ...
                                t.__controls = l, t.setLooping(h), t.setSpeed(parseFloat(p)), t.setDirection(c), "true" !== e && "scroll" === m || o.playSegments([s(y), s(u)], !0), e || (t.pause(), "scroll" === m && r({
                                    ...
                                    mode: "scroll",
                                    actions: [{visibility: [v / 100, g / 100], type: "seek", frames: [s(y), s(u)]}]
        ...
        }), Q && window.flatsomeVars.user.can_edit_pages && ("Prefer reduced motion is active on your OS", "The prefers-reduced-motion media feature is used to detect if the user has requested the system minimize the amount of non-essential motion it uses. With this option enabled, slides & animations are reduced on the frontend.\nCheck your OS documentation on how to disable reduced motion.", console.groupCollapsed("%cFlatsome%c: Prefer reduced motion is active on your OS", "color: #0693e3; font-weight: bold;", "color: inherit;"), console.log("The prefers-reduced-motion media feature is used to detect if the user has requested the system minimize the amount of non-essential motion it uses. With this option enabled, slides & animations are reduced on the frontend.\nCheck your OS documentation on how to disable reduced motion."), console.groupEnd());
        let V = 0;
        let R = 0;
        const q = "scrollBehavior" in document.documentElement.style,
            N = window.getComputedStyle(document.documentElement)["scroll-behavior"];

        function W() {
            window.removeEventListener("keydown", W), window.removeEventListener("pointermove", W), window.removeEventListener("touchstart", W), function () {
                ...
                n.addClass("stuck"), jQuery("body").append(t), V = Math.round(n.height()), t.remove(), window.flatsomeVars.stickyHeaderHeight = V, function (e) {
                ...
                const e = jQuery("#wpadminbar"), t = e.length && e.is(":visible") ? e.height() : 0;
                R = Math.round(window.flatsomeVars.stickyHeaderHeight + t), window.flatsomeVars.scrollPaddingTop = R, jQuery.extend(jQuery.scrollTo.defaults, {
                    axis: "y",
                    duration: Q || q && "smooth" === N ? 0 : 500,
                    offset: -R
                })
            }()
        }
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            window.location.hash || window.scrollY > 200 ? W() : (window.addEventListener("keydown", W, {once: !0}), window.addEventListener("pointermove", W, {once: !0}), window.addEventListener("touchstart", W, {once: !0}))
        }));
        for (const e of ["touchstart", "touchmove"]) jQuery.event.special[e] = {
            setup(t, n, o) {
                this.addEventListener && this.addEventListener(e, o, {passive: !n.includes("noPreventDefault")})
            }
        };
        for (const e of ["wheel", "mousewheel"]) jQuery.event.special[e] = {
            setup(t, n, o) {
                this.addEventListener && this.addEventListener(e, o, {passive: !0})
            }
        };
